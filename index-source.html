...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Source-Files/bower_components/Yamm3/yamm/yamm.css">
        <link rel="stylesheet" href="Source-Files/bower_components/animate.css/animate.css">
        <link rel="stylesheet" href="Source-Files/bower_components/animsition/dist/css/animsition.min.css">
        <link rel="stylesheet" href="Source-Files/bower_components/Ionicons/css/ionicons.css">
        <link rel="stylesheet" href="Source-Files/bower_components/font-awesome/css/font-awesome.css">
        <link rel="stylesheet" href="styles/owl/owl.carousel.css">
        <link rel="stylesheet" href="styles/owl/owl.theme.default.css">
        <link rel="stylesheet" href="Source-Files/bower_components/Swiper/dist/css/swiper.min.css">
    ...
    <body class="light-header animsition">
    	...
    	<script src="Source-Files/bower_components/jquery/dist/jquery.js"></script>

        <!-- ========== MINIFIED PLUGINS JS ========== -->
    	<script src="Source-Files/bower_components/bootstrap-sass/assets/javascripts/bootstrap.js"></script>
        <script src="Source-Files/bower_components/animsition/dist/js/animsition.min.js"></script>
        <script src="Source-Files/bower_components/matchHeight/jquery.matchHeight-min.js"></script>
        <script src="Source-Files/bower_components/parallax.js/parallax.min.js"></script>
        <script src="Source-Files/bower_components/particles.js/particles.min.js"></script>
        <script src="Source-Files/bower_components/scrollreveal/dist/scrollreveal.min.js"></script>
        <script src="Source-Files/bower_components/textillate/assets/jquery.lettering.js"></script>
        <script src="Source-Files/bower_components/textillate/jquery.textillate.js"></script>
        <script src="Source-Files/bower_components/owl/owl.carousel.min.js"></script>
        <script src="Source-Files/bower_components/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="Source-Files/bower_components/jquery.counterup/jquery.counterup.min.js"></script>
        <script src="Source-Files/bower_components/Swiper/dist/js/swiper.jquery.min.js"></script>
